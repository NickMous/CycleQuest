...
function showNotifications() {
    ...
    const notificationInnerDiv = document.getElementById('notificationInnerDiv');
    ...
    const statusClasses = {
        'success': ['bg-pr', 'hover:bg-pr/20', 'dark:bg-dm-pr', 'dark:hover:bg-dm-pr/20'],
        'error': ['dark:bg-dm-red', 'dark:hover:bg-dm-dark_red', 'bg-red', 'hover:bg-red-300'],
        'default': ['bg-pr', 'hover:bg-pr/20', 'dark:bg-dm-pr', 'dark:hover:bg-dm-pr/20']
    };

    const classesToAdd = statusClasses[notification.status] || statusClasses['default'];
                ...
                if (notificationQueue.length > 0) {
                    ...
                    notificationTextDiv.ontransitionend = () => {
                        ...
                        notificationInnerDiv.ontransitionend = () => {
                            ...
                            notificationButton.classList.remove(...classesToAdd);
